<template>
  <div class="table">
    ...
    <div class="table__header">
      ...
      <p>
        Quantity <i class="material-icons" @click="sort('quantity')">sort</i>
      </p>
      <p>
        Distance <i class="material-icons" @click="sort('distance')">sort</i>
      </p>
      <p>Date <i class="material-icons sort-date">sort</i></p>
    </div>

    <div class="table__body">
      <TableRow v-for="row in sortedItems" :key="row.id" :row_data="row" />
    </div>
